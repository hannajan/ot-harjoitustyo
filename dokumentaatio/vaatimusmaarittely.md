...
### Ennen kirjautumista
- _Kauppias_ voi luoda sovellukseen käyttäjätunnuksen.
  - _Työntekijäroolin_ tunnuksia ei voi luoda, vaan ne luo sovellukseen kirjautunut kauppias.
  - Etusivulla on _rekisteröidy_ linkki, jota klikkaamalla aukeaa rekisteröitymislomake.
  - Käyttäjätunnuksen on oltava uniikki ja vähintään 5 merkkiä pitkä.
- _Kauppias_ tai _työntekijä_ voi kirjautua sisään sovellukseen.
  - Etusivulla on kirjautumislomake, johon syötetään käyttäjätunnus ja salasana.
  - Jos kirjautuminen ei onnistu annetaan virheilmoitus, jossa kerrotaan syy.

### Kirjautumisen jälkeen 
#### Kauppias
- voi luoda kaupan
- voi lisätä työntekijän
  - sovellus luo alustavan salasanan työntekijälle, jonka tulee vaihtaa salasana ensimmäisen kirjautumisen yhteydessä.
